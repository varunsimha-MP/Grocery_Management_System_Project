...
$sql = "SELECT * from purchasehistory ph,customerdetails cd where cd.mail=ph.mail and status='To be Deliver' order by dateandtime desc";
...
<td class="text-center py-2"><?php echo $rows['status']?>
<a href="deliveryupdateform.php?pid=<?php echo $rows['pid'] ;?>"> <button type="button" class="btn btn-outline-success"><b>Update</b></button></a></td>

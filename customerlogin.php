...
<div class="container mt-3" style="border: 1px solid black; background-color:#F0f0f0;">
  <br>
  <h1 class="text-success">Customer Login</h1>
  <form>
    <div id="add_err2"></div>
    <div class="form-floating mb-4 mt-4">
      <input type="text" class="form-control" id="mail" placeholder="Account ID" name="mail" required>
    ...
    <button type="submit" id="login" class="btn btn-outline-success"><b>Login</b></button>
    <a href="customerregister.php"<button type="submit" class="btn btn-outline-success"><b>Not a member?Sign Up</b></button></td></a>
    </form>
    <br>
</div>
</center>

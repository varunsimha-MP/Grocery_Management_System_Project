...
$sql="SELECT * FROM manager WHERE mail='$mail'";
...
<div class="container mt-3" style="border: 1px solid black; background-color:#F0f0f0;">
  <br>
  <h1 class="text-black">Manager</h1>
  <h5 class="text-success">Full Name: <?php echo $fname;?></h5>
<h5 class="text-success">Mail Id: <?php echo $mail;?></h5>
  <form action="mupdatepassword.php" method="post">
    <div class="form-floating mb-3 mt-3">
      <input type="password" class="form-control" id="mpassword" placeholder="New Password" name="mpassword" required>
      <label for="password">New Password</label>
    </div>
    <input type="submit" value="Change Password" class="btn btn-outline-success"><br><br>
    <input type="hidden" name="mail" value="<?php echo $mail;?>" >
    <a href="managerpage.php"> <button type="button" class="btn btn-outline-success">Back</button></a>
  </form>
  <br>
</div>
</center>
